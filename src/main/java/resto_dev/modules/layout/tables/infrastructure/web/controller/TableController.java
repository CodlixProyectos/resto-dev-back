...
public class TableController {
    ...
    @Operation(summary = "Crear nueva mesa", description = "Crea una mesa asociándola a una Zona existente.")
    public ResponseEntity<ApiResponse<TableResponse>> createTable(
        ...
        return new ResponseEntity<>(ApiResponse.created(webMapper.toResponse(createdTable), "Mesa creada exitosamente"),
                HttpStatus.CREATED);
    }
